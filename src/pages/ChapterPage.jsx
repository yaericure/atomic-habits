    ...
    <div className="flex min-w-0 flex-1">
      <main className="min-w-0 flex-1 px-5 py-8 sm:px-8 lg:px-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 h-1.5 w-36 rounded-full bg-gradient-to-r from-emerald-600 via-emerald-400 to-emerald-200 dark:from-emerald-400 dark:via-emerald-500 dark:to-emerald-900" />
        </div>
        ...
        <footer className="mt-10 pb-4 text-xs leading-relaxed text-zinc-400">
          本站為《原子習慣》(詹姆斯・克利爾 James Clear 著,方智出版)的教學導讀筆記,內容為重點整理與延伸解說,並非原書全文。完整內容請支持正版書籍。
        </footer>
      </main>
